...
class Beam:
    ...
    next_word: str
    partial_word: str
    partial_word_with_delimiter: str
    ...
    def from_lm_beam(cls, lm_beam: LMBeam) -> "Beam":
        ...
        return Beam(
            ...
            partial_word_with_delimiter=lm_beam.partial_word_with_delimiter,
...
class BeamSearchDecoderCTC:
            ...
            for beam in beams:
                ...
                new_beams.append(
                    LMBeam(
                        ...
                        partial_word_with_delimiter=beam.partial_word_with_delimiter,
                    ...
                    # if bpe and leading space char
                        ...
                        new_beams.append(
                            Beam(
                                ...
                                partial_word_with_delimiter=clean_char,
                                last_char=char,
                    ...
                    # general update of continuing token without space
                        ...
                        new_beams.append(
                            Beam(
                                text=beam.text,
                                next_word=beam.next_word,
                                partial_word=beam.partial_word + char,
                                partial_word_with_delimiter=beam.partial_word_with_delimiter + ' | ' + char,
                                last_char=char,
                                text_frames=beam.text_frames,
                                partial_frames=new_part_frames,
                                logit_score=beam.logit_score + p_char,
    ...
    def _decode_logits(
        ...
        # print(f"\nTrimmed Beams: {trimmed_beams}\n")

        # remove unnecessary information from beams
        output_beams = [
            OutputBeam(
                text=_normalize_whitespace(lm_beam.text),
                text_with_delimiter=lm_beam.partial_word_with_delimiter,
                last_lm_state=(
    ...
    def decode(
        ...
        # get the text list splitted by delimiter for the tokenizer to map and decode, also remove the excessive first empty str element
        top_beam_list = decoded_beams[0].text_with_delimiter.split(' | ')[1:]

        return top_beam_list
